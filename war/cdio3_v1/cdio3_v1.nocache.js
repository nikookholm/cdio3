...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "cdio3_v1" because\n';
  ...
  $wnd.__gwt_activeModules['cdio3_v1'] = {
    'moduleName' : 'cdio3_v1',
    'bindings' : function() {
      return {};
    }
 ...
 * "/cdio3_v1.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['cdio3_v1'].superdevmode = true;

  var expectedSuffix = '/cdio3_v1.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + cdio3_v1 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:cdio3_v1';
  var devModeSessionKey = '__gwtDevModeSession:cdio3_v1';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/cdio3_v1/cdio3_v1.nocache.js';
  ...
  $wnd.__gwt_activeModules['cdio3_v1'].canRedirect = true;
  $wnd.__gwt_activeModules['cdio3_v1'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/cdio3_v1?user.agent=' + ua + '&_callback=' + callback;
